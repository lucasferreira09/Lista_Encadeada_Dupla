...
##A PARTIR DE UMA CHAVE NUMÉRICA ENTRE 1 E 25
import string 
...
chave = int(input("Qual a chave de codificação? Entre 1-25: "))
...
for letra in msg_original:
    for letra2 in list(letra):
        posicao_letra = int(alfa_original.index(letra2)+1) + chave
        codifica_letra = alfa_cifrado[posicao_letra-chave-1]
